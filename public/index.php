    ...
    <section class="section section-captaciones">
        ...
        <div class="cards-container">
            <div class="card">
                ...
                <a href="../app/views/credito_vehicular.php" class="interest-button">Me interesa</a>
            </div>

            <div class="card">
                <h3 class="card-title">Crédito Universitario</h3>
                <p class="card-text">Financia tus estudios con cuotas accesibles.</p>
                <a href="app/views/credito_universitario.php" class="interest-button">Me interesa</a> <!-- Actualizado -->
            </div>
            <div class="card">
                <h3 class="card-title">Crédito Hipotecario</h3>
                <p class="card-text">Compra la casa de tus sueños con facilidades de pago.</p>
                <a href="app/views/credito_hipotecario.php" class="interest-button">Me interesa</a> <!-- Actualizado -->
            </div>
        </div>
    </section>
    ...
    <section class="section section-colocaciones">
        ...
        <div class="cards-container">
            <div class="card">
                ...
                <a href="app/views/plazo_fijo.php" class="interest-button">Me interesa</a> <!-- Actualizado -->
            </div>
        </div>
    </section>
